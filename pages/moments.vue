...
export default {
  data() {
    return {
      moments: [
        {
          text: "昨天晚上手机突然就开始无限重启了，今天去售后修要400块觉得不太划算，就到小米之家以旧换新了，换了红米K30 Pro，售价2700，旧手机折了500块。换机导数据的时候一直祈祷着旧手机别中途无限重启，好在一直坚持到了最后。",
          icon: "7/2"
        },
        {
          text: "FGO2.4章花了两天通关了，只有最后两次打阿周那和空想树比较难.19-1的阿周那是迦摩体验关，借了一个3宝迦摩，直接秒第一面的芦屋道满，打阿周那用月灵髓液撑住等迦摩np满。19-2还是用月灵髓液硬撑，令咒给迦尔纳放宝具。19-4用艾蕾过，中间渣操翻车了一次，要点还是月灵髓液。",
          icon: "6/30"
        },
        {
          text: "练了二十多天的车，终于把科二考过了。第一圈还没开出去多久就报不及格，原来是前面的人把数码的安全带插孔给解开了，还掉在了座椅下面，而我把安全带插在了车本身的机械安全带插孔里。还好第二圈90分，就是坡道离边线稍微远了一些扣了十分。还好第二圈过了，要不然就被坑了。😨",
          icon: "6/29"
        },
        {
          text: "🕯️",
